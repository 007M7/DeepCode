...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/cli-app': { kind: 'none', reason: 'The terminal runner submits ordinary user messages; prompts, tools, and command-owned model context belong to the composed plugins.' },
